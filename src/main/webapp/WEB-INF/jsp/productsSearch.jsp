...
<head>
    ...
    <title>Online Shop App | Search Products</title>
    <%--  for clean code we transformed the links and scripts path  --%>
    <jsp:include page="partial/home/homeHeader.jsp"></jsp:include>
    <script src="/scripts/controllers/site/search/productsSearchController.js"></script>

</head>
<body ng-app="onlineShoppApp" ng-controller="productsSearchCtrl">
...
<div class="container-fluid py-5" ng-init="initSearch('${dataSearch}')">
    <div class="row">
        <div class="col-1"></div>
        <div class="col">
            ...
            <div class="row mb-5">
                <h1 class="text-center fw-bold my-5 text-center">{{category.title}}
                    <a href="/products"
                       class="btn btn-lg btn-outline-dark text-danger border-secondary float-start bg-gradient">Return</a>
                </h1>
            </div>
