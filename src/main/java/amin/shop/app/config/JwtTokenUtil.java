...
public class JwtTokenUtil implements Serializable {
    ...
    // <<5 * 60 * 60>> use time client at token.(time is second).
    public static final long JWT_TOKEN_VALIDITY = 5 * 60 * 60;

    //use @Value(...), search(...) in application.property.
    @Value("${jwt.secret}")
    ...
    //this method use when will save once information in token.
