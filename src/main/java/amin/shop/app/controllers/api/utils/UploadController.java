package amin.shop.app.controllers.api.utils;

import amin.shop.app.enums.ResponseStatus;
import amin.shop.app.helper.ui.ServiceResponse;
import amin.shop.app.helper.uimodels.UploadForm;
...
/**
 * my description :
 * for upload images or files in application.
 * by JSP.
 * create such as component.
 * use : <Slider>
 */
@RestController
