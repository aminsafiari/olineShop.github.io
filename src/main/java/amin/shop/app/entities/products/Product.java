...
public class Product {
    ...
    //in description is by default 255 charset, when save data, make exception, for this we write length = 40000.
    @Column(length = 4000)
